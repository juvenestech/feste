(() => {
  ...
  const GOOGLE_REDIRECT_URI =
    "https://n8n.delugan.net/webhook/juvenes/feste/callback";
  ...
  function renderCalendar(groupedSlots) {
    ...
    if (!groupedSlots.length) {
      renderPlaceholderMessage(
        "Al momento non ci sono turni disponibili per la Feste Juvenes/Rainerum."
      );
      return;
    }
  ...
  async function fetchAvailabilityData() {
    const endpoint =
      "https://n8n.delugan.net/webhook/juvenes/feste/slots";
